...
class TokenModePanelUI extends StatefulWidget {
  const TokenModePanelUI({super.key});

  @override
  State<StatefulWidget> createState() => _TokenModePanelUIState();
}

class _TokenModePanelUIState extends State {
            ...
            children: <Widget>[
              ...
              Row(
                ...
                children: <Widget>[
                  ...
                  ElevatedButton(
                    onPressed: () async {
                      final String? frpToken = await TokenInfoPrefs.getFrpToken();
                      // 判断frp_token是否为空
                      if (frpToken != null) {
