...
// Project imports:
import 'package:nyalcf/core/tasks/auto_sign.dart';
import 'package:nyalcf/core/tasks/refresh_access_token.dart';
import 'package:nyalcf/core/tasks/update_proxies_list.dart';
import 'package:nyalcf/core/tasks/updater.dart';
...
class TaskScheduler {
  ...
  static Future<void> start() async {
    ...
    if (Env.gui.disableAutoUpdateCheck ?? false) _taskUpdater();
    _taskAutoSign();
